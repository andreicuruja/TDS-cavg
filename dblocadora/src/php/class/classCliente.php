...
class Cliente
{
    ...
    public function inserirCliente(){
        $cpf = trim($this->cpf);  // Garantir que não há espaços extras
    
        // Verifique os dados sendo enviados para o banco
        var_dump($this->nome, $cpf, $this->endereco);
        ...
        if($stmt->execute()){
            ...
            // Verificando se o cliente foi realmente inserido
